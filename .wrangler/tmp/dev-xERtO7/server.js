...
// .wrangler/tmp/bundle-9Abmcy/checked-fetch.js
...
async function addEstoque(request, env) {
  try {
    ...
    ).bind(data.produto_id, data.quantidade).run();
    return new Response(JSON.stringify({ message: "Item adicionado!" }), {
      headers: { "Content-Type": "application/json" }
    });
  } catch (error) {
...
// .wrangler/tmp/bundle-9Abmcy/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-9Abmcy/middleware-loader.entry.ts
